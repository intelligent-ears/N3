...
async function testIntegration() {
  ...
  try {
    ...
    const analysisResponse = await axios.get(`http://127.0.0.1:8080/api/analyze`, {
    ...
    const contractResponse = await axios.get(`http://127.0.0.1:8080/api/contract`, {
      params: { address: contractAddress, network }
    });
    ...
    console.log('\nDemo is now available at http://127.0.0.1:8080');
    console.log('MCP server is running at http://127.0.0.1:3000');
